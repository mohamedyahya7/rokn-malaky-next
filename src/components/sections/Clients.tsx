      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-8">
          {clients.map((client, idx) => (
            <div 
              key={idx}
              className="group relative bg-white border border-slate-100 w-40 h-32 md:w-56 md:h-40 rounded-2xl shadow-sm flex items-center justify-center p-6 hover:shadow-lg hover:border-[var(--primary)] transition-all duration-300 transform hover:-translate-y-1"
            >
